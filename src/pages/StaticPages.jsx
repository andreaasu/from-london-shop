    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-2xl">
            ...
            <p className="mb-4 text-gray-700 leading-relaxed">
                Welcome to From London. We bring you the latest high-street fashion trends inspired by the energetic vibe of London.
    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-2xl">
            ...
            <div className="space-y-4 mb-8">
                <p><strong>Email:</strong> support@fromlondon.com</p>
