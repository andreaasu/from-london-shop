...
export default function Shop() {
    ...
    // Sync URL params to Context on mount/update
    ...
    const filteredProducts = useMemo(() => {
        return products.filter(product => {
            ...
            if (filterGender) {
                ...
                // User prompt: "checked={selectedGender === "women"}" implied strictness.
                // Common logic: Women's page shows Women + Unisex. Men's page shows Men + Unisex.
